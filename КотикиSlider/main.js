const slider = {
    ...
    gettingImages: function (imgArr) {
        this.images = imgArr;
    },
    imgDemonstration: function (position) {
    ...
    start: function (position,imgArr) {
        if (!this.sliderOn) {
...
slider.start(3,["https://avatars.mds.yandex.net/i?id=ba7352ff1098bd28cf3f0b0d1d2107f8-4012518-images-thumbs&n=13&exp=1",
